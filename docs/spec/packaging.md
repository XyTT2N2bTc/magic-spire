...
当前 project.godot 及两平台预设统一为 0.18.1；Windows 文件版本 0.18.1.0，Android 安装版本13并保留原签名。两平台随包版本说明均读取 `docs/record/release-notes/release-v0.18.1.txt`，Android 附专用说明及基础操作教学。历史标签和安装包不覆盖。
...
- **版本号来源**：脚本从 `project.godot` 读取版本并选择同名导出预设；当前版本、Windows 文件版本、
  Android 安装版本与随包版本说明文件名见本文「v0.18.1 修复与维护版」段。不手改脚本内的版本常量。
