...
static var TYPES={
 ...
 "cursed_plate_lock":{"rarity":"boss","name":"诅咒平板锁","detail":"能量上限＋1。拾取时，强制佩戴紧度3档、无限持续的高级平板锁。击败下一个Boss获得专属钥匙，自动解锁并取下整件；此前无法解除。","modifiers":{"max_energy":1}},
 ...
 "green_bird":{"rarity":"rare","name":"绿色小鸟","detail":"每场战斗前6回合，快感不会超过99。","modifiers":{"pressure_guard_turns":6}},
