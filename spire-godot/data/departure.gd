...
const GROUPS=[["remove","transform","uncommon"],["flask","mana","common_relic","potion"],["rare_card","rare_relic","curse","basics","wrist"],["boss"]]
const CATEGORIES=["卡牌","资源／遗物","代价交换","初始遗物交换"]
const OPTIONS={
 "remove":"移除1张牌。",
