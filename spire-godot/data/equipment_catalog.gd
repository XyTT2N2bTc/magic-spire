...
static func entries() -> Dictionary:
 ...
 var exit_practices={
  "prison_release":["到期出狱练习","从正常收押开始，按1级监狱规则佩戴装备并登记；进入牢房后从第1回合开始，初始刑期20回合，巡视间隔16回合。","自行挣脱、探索或等待；每次检查有违规最多延长8回合。刑期结束后须通过出狱检查，才能选择10—11层非休息、非宝箱起点。"],
  "prison_release_violation":["巡视与延期练习","同样从正常收押和第1回合开始。可尝试解除已登记装备，观察巡视时的补装和延期；练习不会预设检查结果。","登记装备缺失或检查时工具被没收，当次期限延长8回合。刑期结束后进行出狱检查；未通过则继续服刑8回合。"],
