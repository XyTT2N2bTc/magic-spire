...
static func card_metadata(type: String, mana_costs: Dictionary={}, base: Variant=null, worn_count: Variant=null) -> Dictionary:
 ...
 var effects=card_info(type,costs,base,false,worn_count)
