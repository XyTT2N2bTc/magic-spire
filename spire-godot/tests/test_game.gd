...
func _more_tests() -> void:
 ...
 check(action(g,"end").ok and g.state.enemies[1].intent.kind=="apply" and g.state.enemies[1].intent.grade==2 and g.state.enemies[1].intent.tier==2,"TC-ENEMY-0003 preparation advances to declared final application")
