...
static func run(t) -> void:
 ...
 t.check(picker.item_count==3 and picker.get_item_text(1)=="English" and picker.get_item_text(2)=="日语（待翻译）","LOCALE UI distinguishes finished English from the empty Japanese pack")
