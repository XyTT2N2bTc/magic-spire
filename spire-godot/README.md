...
2026-09-13本地化框架：新增固定文案ID、中文资源、空日语资源、命名参数校验与中文回退；显示设置可选择语言并独立保存。主页主要按钮与显示／声音设置先行接入，其他文案留待分批迁移，本轮未翻译、未打包。说明与文案盘点命令见`docs/localization.md`。
...
2026-09-11新增罕见能力“拘束之拥”：自由面2费，每挣脱1件拘束具抽1张；拘束面1费，每被佩戴1件拘束具，下回合抽1张。两面持续整场、可反复触发；待抽张数显示在对应状态图标，卡面保持固定说明。加入罕见卡池及图鉴，配有独立小画。
...
2026-09-11调整稀有遗物绿色小鸟：每场战斗、牢房、休息和整备的前6回合，快感值最多99；第7回合恢复正常，超出部分不累积。图标显示剩余保护回合。
