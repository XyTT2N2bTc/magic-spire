...
2026-09-13新增罕见唯一能力「再利用」：自由1费，失败退80%临时耗魔；拘束2费，上身／腿部均2级退80%、均3级退100%，实时检测、各池原路返还。卡面、图鉴、状态与施法提示同步；规则专项通过，窗口检查无失败，验证范围见docs/verification.md，未打包。
